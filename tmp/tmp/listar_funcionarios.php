<?php 
	...
	$cnx=conexion($db);
		...
		$sql="SELECT * from funcionarios order by str_nombre desc";
				...
				<table class="table table-striped table-bordered">
					<thead>
						<tr>
							...
							<th scope="col">Codigo Ciudad <i class="fas fa-walking"></i> </th>
							<th scope="col">Codigo Pais <i class="fas fa-walking"></i> </th>
						</tr>
					</thead>
					<tbody>
