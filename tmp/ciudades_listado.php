<?php 
	...
	$cnx=conexion($db);
		...
		foreach ($resultado as $rs ) {					
			...
			$delete="<a href='ciudades_eliminar.php?num_id=$rs[num_id]'><i class='fas fa-trash-alt'></i></a>";

			$edit="<a href='ciudades_editar.php?num_id=$rs[num_id]'><i class='far fa-edit'></i></a>";
	...
	<div class='container'>
		<div class='row'>
			<div class='col' >
				...
				<h5>Ciudades</h5>
				<div> <a href='ciudades_agregar.php'><i class="fas fa-plus"></i> Agregar Ciudad </a></div>
